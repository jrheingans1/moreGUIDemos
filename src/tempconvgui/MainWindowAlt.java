 ...
 * @author jlombardo
 */
public class MainWindowAlt extends javax.swing.JFrame implements ActionListener {
    ...
    public void actionPerformed(java.awt.event.ActionEvent evt) {
        if (evt.getSource() == btnConvert) {
            MainWindowAlt.this.btnConvertActionPerformed(evt);
        }
        else if (evt.getSource() == btnExit) {
            MainWindowAlt.this.btnExitActionPerformed(evt);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MainWindowAlt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new MainWindowAlt().setVisible(true);
            }
        });
    }
